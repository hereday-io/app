...
const Index = () => {
  ...
  return (
    ...
    >
      {/* Structured data is NOT rendered here. api/page/[name].ts injects
          all three schemas into the shell's <head> server-side, so they
          exist in the served HTML instead of only after hydration.
          Rendering them again from React would duplicate every block.
          Source of truth: src/lib/homepageSchema.ts. */}
