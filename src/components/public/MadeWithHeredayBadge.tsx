...
const MadeWithHeredayBadge = () => {
  return (
    <a
      ...
      className="fixed z-[60] bottom-3 left-3 flex items-center gap-1.5 rounded-full border border-border/80 bg-background/90 px-2.5 py-1 text-[11px] font-medium text-muted-foreground shadow-sm backdrop-blur-sm hover:text-foreground hover:border-primary/40 transition-colors"
